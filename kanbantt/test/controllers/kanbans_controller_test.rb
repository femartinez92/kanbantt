...
class KanbansControllerTest < ActionController::TestCase
  ...
  test "should create kanban" do
    assert_difference('Kanban.count') do
      post :create, kanban: { id_column: @kanban.id_column, id_task: @kanban.id_task, position: @kanban.position }
    end
  ...
  test "should update kanban" do
    patch :update, id: @kanban, kanban: { id_column: @kanban.id_column, id_task: @kanban.id_task, position: @kanban.position }
    assert_redirected_to kanban_path(assigns(:kanban))
  end
